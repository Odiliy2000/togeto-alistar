...
const HeaderMenus = () => {
  ...
  {menuData.map((menu) => (
    <li
      key={menu.id}
      className={
        menu.title !== 'Home' && (menu.home_menus || menu.dropdown_menus)
    ...
    >
      ...
      {/* REMOVE DROPDOWN IF menu.title === 'Home' */}
      {menu.title !== 'Home' && menu.home_menus ? (
      ...
      ) : menu.title !== 'Home' && menu.dropdown_menus ? (
